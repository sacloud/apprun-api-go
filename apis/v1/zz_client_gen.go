...
type ListApplicationsResponse struct {
	...
	JSON400      *ModelDefaultError
	JSON401      *ModelDefaultError
	JSON403      *ModelDefaultError
	JSON500      *ModelDefaultError
}
